    ...
    data: [
      {
        ...
        demo: {
          ...
          stacks: 'React 19, TypeScript, Vite, Tailwind CSS 4, Web Worker, SharedArrayBuffer, Canvas, CanvasKit (Skia/WASM), FlatBuffers (schema), pnpm Workspace Monorepo, ESLint'
        }
      }
    ]
  },
